...
void ToolBar::MakeActions()
{
  ...
  m_wii_menu_action = addAction(tr("Wii Menu"), this, &ToolBar::WiiMenuPressed);
  ...
  for (const auto& action :
       {m_open_action, m_pause_play_action, m_stop_action, m_stop_action, m_fullscreen_action,
        ...
        m_wii_menu_action, m_step_action, m_step_over_action, m_step_out_action, m_skip_action,
...
void ToolBar::UpdateIcons()
{
  ...
  m_wii_menu_action->setIcon(Resources::GetThemeIcon("wiimote"));
}
